...
def run(settings):
    ...
    if settings.local_rank != -1:
        # net = torch.nn.SyncBatchNorm.convert_sync_batchnorm(net)  # add syncBN converter # zzf 原本应该注掉
    ...
    if settings.script_name == "tbsi_track":
        ...
        loss_weight = {'giou': cfg.TRAIN.GIOU_WEIGHT, 'l1': cfg.TRAIN.L1_WEIGHT, 'focal': cfg.TRAIN.LOCATION_WEIGHT, 'cls': 1.0}
