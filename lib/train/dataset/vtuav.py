...
class VTUAV(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, modality=None):
        if modality is None:
    ...
    def _get_frame(self, seq_path, frame_id):
        img1 = self.image_loader(self._get_frame_path(seq_path, 'rgb', frame_id))
        img2 = self.image_loader(self._get_frame_path(seq_path, 'ir', frame_id))
        return np.concatenate((img1, img2), 2)
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        seq_path = self._get_sequence_path(seq_id)
        frame_list = [self._get_frame(seq_path, seq_id) for seq_id in frame_ids]
