...
#  --save_dir=/data/szk/Project/TBSI_TU_0509/train_tta_output_一阶段 2>&1 |
#  tee /data/szk/Project/TBSI_TU_0509/train_tta_output_一阶段.log
#
...
#  --save_dir=/data/szk/Project/TBSI_TU_0509/train_tta_output_二阶段 2>&1 |
#  tee /data/szk/Project/TBSI_TU_0509/train_tta_output_二阶段.log
